...
public class CurriculoAnalyzer {
    ...
    public CurriculoAnalyzer returnStatement() {
		return new CurriculoAnalyzer();
	}

	public CurriculoResult analizadorCurriculo(Curriculo curriculo, Map<EnumPublicationLocalType, QualisData> qualisDataMap) {
