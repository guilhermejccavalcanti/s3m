...
public class cgBase {
    ...
    public static final Map<WaypointType, String> waypointTypes = new HashMap<WaypointType, String>();
    ...
    private static final SimpleDateFormat dateTbIn1 = new SimpleDateFormat("EEEEE, dd MMMMM yyyy", Locale.ENGLISH);
    ...
    // Saturday, March 28, 2009public static String version = null;
    /**
    ...
    public static void switchToEnglish(String previousPage) {
        ...
        if (previousPage != null && previousPage.indexOf(ENGLISH) >= 0) {
            ...
            final Parameters params = new Parameters(// switch to english
            "__EVENTTARGET", // switch to english
            "ctl00$uxLocaleList$uxLocaleList$ctl00$uxLocaleItem", "__EVENTARGUMENT", "");
    ...
    private static List<cgLog> loadLogsFromDetails(final String page, final cgCache cache, final boolean friends) {
        ...
        final Parameters params = new Parameters("tkn", userToken, "idx", "1", "num", "35", "decrypt", "true", // "sp", Boolean.toString(personal), // personal logs
    ...
    public static String[] requestViewstates(final String uri, final Parameters params, boolean xContentType, boolean my) {
        final HttpResponse response = request(uri, params, xContentType, my, false);
        return getViewstates(getResponseData(response));
    }

    public static String getResponseDataOnError(final HttpResponse response) {
        try {
    ...
    private static final HttpParams clientParams = new BasicHttpParams();
