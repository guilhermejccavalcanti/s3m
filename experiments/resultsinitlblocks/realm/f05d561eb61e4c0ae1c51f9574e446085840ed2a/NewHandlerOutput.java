...
public abstract class  BaseRealm implements Closeable {
	...
	// Thread pool for all async operations (Query / transaction / network requests)static final RealmThreadPoolExecutor asyncTaskExecutor = RealmThreadPoolExecutor.newDefaultExecutor();
	final long threadId;
