...
import android.content.Context; import android.os.Handler; import android.os.Looper; import android.util.Log; import com.getkeepsafe.relinker.BuildConfig; import java.io.Closeable; import java.io.File; import java.io.FileNotFoundException; import java.util.Arrays; import java.util.Collections; import java.util.List; import java.util.concurrent.atomic.AtomicBoolean; import io.realm.exceptions.RealmFileException; import io.realm.exceptions.RealmMigrationNeededException; import io.realm.internal.InvalidRow; import io.realm.internal.RealmObjectProxy; import io.realm.internal.SharedRealm; import io.realm.internal.ColumnInfo; import io.realm.internal.Row; import io.realm.internal.Table; import io.realm.internal.UncheckedRow; 
import io.realm.internal.Util; import io.realm.internal.async.RealmThreadPoolExecutor; import io.realm.log.AndroidLogger; import io.realm.log.RealmLog; import io.realm.objectserver.internal.ObjectServerFacade; import rx.Observable; /**
...
public abstract class  BaseRealm implements Closeable {
	...
	// FIXME Make package protected once all sync code moves to io.realm
    ...
    //          package private, for test purpose onlyvoid setHandler(Handler handler) {
	...
	// package protected so unit tests can access itvoid setVersion(long version) {
    ...
    // Invariant: if dynamicClassName != null -> clazz == DynamicRealmObject<E extends RealmModel> E get(Class<E> clazz, String dynamicClassName, long rowIndex) {
	...
	// Return true if this Realm can receive notifications.boolean hasValidNotifier() {
	...
	// Internal delegate for migrationsprotected interface  MigrationCallback {
