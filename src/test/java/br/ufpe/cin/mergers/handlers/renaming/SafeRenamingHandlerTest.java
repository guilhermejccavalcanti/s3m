...
public class SafeRenamingHandlerTest { 
	...
	***********************/
	...
	public void testHandle_whenBothRenameMethodWithoutBodyChanges_andBothRenameToDifferentNames_shouldReportConflict() {
		...
		TestUtils.verifyMergeResultWithRenamingConflict(mergeContext, "<<<<<<<MINEpublicvoidmethod1(intx,inty){inta;intb;intc;}|||||||BASEpublicvoidmethod(intx,inty){inta;intb;intc;}=======publicvoidmethod2(intx,inty){inta;intb;intc;}>>>>>>>YOURS");
	}
	...
	public void testHandle_whenLeftRenamesMethodWithoutBodyChanges_andRightRenamesMethodWithBodyChanges_andBothRenameToDifferentNames_shouldReportConflict() {
		...
		TestUtils.verifyMergeResultWithRenamingConflict(mergeContext,
				"<<<<<<<MINEpublicvoidmethod1(intx,inty){inta;intb;intc;}|||||||BASEpublicvoidmethod(intx,inty){inta;intb;intc;}=======publicvoidmethod2(intx,inty){inta;intb;intd;}>>>>>>>YOURS");
	}
	...
	public void testHandle_whenRightRenamesMethodWithoutBodyChanges_andLeftRenamesMethodWithBodyChanges_andBothRenameToDifferentNames_shouldReportConflict() {
		...
		TestUtils.verifyMergeResultWithRenamingConflict(mergeContext,
				"<<<<<<<MINEpublicvoidmethod1(intx,inty){intd;intb;intc;}|||||||BASEpublicvoidmethod(intx,inty){inta;intb;intc;}=======publicvoidmethod2(intx,inty){inta;intb;intc;}>>>>>>>YOURS");
	}
	...
	public void testHandle_whenBothRenameMethodWithBodyChanges_andBothRenameToDifferentNames_shouldReportConflict() {
		...
		TestUtils.verifyMergeResultWithRenamingConflict(mergeContext,
				"<<<<<<<MINEpublicvoidmethod1(intx,inty){intd;intb;intc;}|||||||BASEpublicvoidmethod(intx,inty){inta;intb;intc;}=======publicvoidmethod2(intx,inty){inta;intb;intd;}>>>>>>>YOURS");
	}
	...
	public void testHandle_whenLeftDeletesMethod_andRightRenamesMethod_shouldReportConflict() {
		...
		TestUtils.verifyMergeResultWithRenamingConflict(mergeContext,
				"<<<<<<<MINE|||||||BASEpublicvoidmethod(intx,inty){inta;intb;intc;}=======publicvoidmethod1(intx,inty){intd;intb;intc;}>>>>>>>YOURS");
	}
	...
	public void testHandle_whenRightDeletesMethod_andLeftRenamesMethod_shouldReportConflict() {
		...
		TestUtils.verifyMergeResultWithRenamingConflict(mergeContext,
				"<<<<<<<MINEpublicvoidmethod2(intx,inty){inta;intb;intc;}|||||||BASEpublicvoidmethod(intx,inty){inta;intb;intc;}=======>>>>>>>YOURS");
	}
