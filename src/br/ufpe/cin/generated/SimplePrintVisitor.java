...
public class SimplePrintVisitor extends AbstractFSTPrintVisitor {
	...
	public boolean visit(FSTNonTerminal nonTerminal) {
		...
		if (nonTerminal.getType().equals("EnumBodyInternal")) {
			...
			hintIncIndent();
			hintNewLine();
			for (FSTNode v : getChildren(nonTerminal,
		...
		if (nonTerminal.getType().equals("ConstructorDeclaration")) {
			...
			hintNewLine();
			{
				FSTNode v = getChild(nonTerminal,
		...
		if (nonTerminal.getType().equals(
				"ExplicitConstructorInvocationThisArguments")) {
			printFeatures(nonTerminal, true);
			printToken("this");
			{
				FSTNode v = getChild(nonTerminal, "Arguments");
		...
		if (nonTerminal.getType().equals(
				"ExplicitConstructorInvocationThisTypeArguments")) {
			printFeatures(nonTerminal, true);
			{
		...
		if (nonTerminal.getType().equals("ConditionalOrExpression")) {
			printFeatures(nonTerminal, true);
			Iterator<FSTNode> listElements = getChildren(nonTerminal,
					"ConditionalAndExpression").iterator();
			if (listElements.hasNext()) {
				listElements.next().accept(this);
			}
			while (listElements.hasNext()) {
		...
		if (nonTerminal.getType().equals("ConditionalAndExpression")) {
			printFeatures(nonTerminal, true);
			Iterator<FSTNode> listElements = getChildren(nonTerminal,
					"InclusiveOrExpression").iterator();
			if (listElements.hasNext()) {
				listElements.next().accept(this);
			}
			while (listElements.hasNext()) {
		...
		if (nonTerminal.getType().equals("InclusiveOrExpression")) {
			printFeatures(nonTerminal, true);
			Iterator<FSTNode> listElements = getChildren(nonTerminal,
					"ExclusiveOrExpression").iterator();
			if (listElements.hasNext()) {
				listElements.next().accept(this);
			}
			while (listElements.hasNext()) {
		...
		if (nonTerminal.getType().equals(
				"UnaryExpressionNotPlusMinusCastExpression")) {
			printFeatures(nonTerminal, true);
			{
		...
		if (nonTerminal.getType().equals(
				"UnaryExpressionNotPlusMinusPostfixExpression")) {
			printFeatures(nonTerminal, true);
			{
		...
		if (nonTerminal.getType().equals(
				"AllocationExpressionInitArrayDimsAndInits")) {
			printFeatures(nonTerminal, true);
			{
				FSTNode v = getChild(nonTerminal, "ArrayDimsAndInits");
				if (v != null) {
	...
	protected boolean isSubtype(String type, String expectedType) {
		if (type.equals(expectedType))
			return true;
		if (type.equals("ConditionalExpression1")
				&& expectedType.equals("ConditionalExpression"))
			return true;
		if (type.equals("CastExpression3")
				&& expectedType.equals("CastExpression"))
			return true;
		if (type.equals("PrimaryPrefix15")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("InnerEnumDecl")
				&& expectedType.equals("ClassOrInterfaceBodyDeclaration"))
			return true;
		if (type.equals("LambdaExpression1")
				&& expectedType.equals("LambdaExpression"))
			return true;
		if (type.equals("UnaryPreDecrement")
				&& expectedType.equals("UnaryExpression"))
			return true;
		if (type.equals("MultipleCatching")
				&& expectedType.equals("CatchBlockInternal"))
			return true;
		if (type.equals("PostfixOp1") && expectedType.equals("PostfixOp"))
			return true;
		if (type.equals("MultiplicativeOp1")
				&& expectedType.equals("MultiplicativeOp"))
			return true;
		if (type.equals("PrimaryPrefix1")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("ConditionalExpression2")
				&& expectedType.equals("ConditionalExpression"))
			return true;
		if (type.equals("LambdaExpression2")
				&& expectedType.equals("LambdaExpression"))
			return true;
		if (type.equals("EnumDecl") && expectedType.equals("TypeDeclaration"))
			return true;
		if (type.equals("PrimaryPrefix16")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("PostfixOp2") && expectedType.equals("PostfixOp"))
			return true;
		if (type.equals("PrimaryPrefix2")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("Assignment")
				&& expectedType.equals("StatementExpressionAssignment"))
			return true;
		if (type.equals("TypeArgument2") && expectedType.equals("TypeArgument"))
			return true;
		if (type.equals("RelationalOp1") && expectedType.equals("RelationalOp"))
			return true;
		if (type.equals("SwitchStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("AnnotationInnerFieldDecl")
				&& expectedType.equals("AnnotationTypeMemberDeclaration"))
			return true;
		if (type.equals("DoStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("AssertStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("UnaryOp2") && expectedType.equals("UnaryOp"))
			return true;
		if (type.equals("TypeArgument1") && expectedType.equals("TypeArgument"))
			return true;
		if (type.equals("ClassOrInterfaceDecl")
				&& expectedType.equals("TypeDeclaration"))
			return true;
		if (type.equals("RelationalOp2") && expectedType.equals("RelationalOp"))
			return true;
		if (type.equals("AllocationExpressionArray")
				&& expectedType.equals("AllocationExpression"))
			return true;
		if (type.equals("TryStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("Modifier1") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("Literal1") && expectedType.equals("Literal"))
			return true;
		if (type.equals("RelationalOp3") && expectedType.equals("RelationalOp"))
			return true;
		if (type.equals("Modifier13") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("ExplicitConstructorInvocationThisTypeArguments")
				&& expectedType.equals("ExplicitConstructorInvocation"))
			return true;
		if (type.equals("SynchronizedStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("AssignmentOperator2")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("PreDecrementStmtExp")
				&& expectedType.equals("StatementExpression"))
			return true;
		if (type.equals("AnnotationInnerEnumDecl")
				&& expectedType.equals("AnnotationTypeMemberDeclaration"))
			return true;
		if (type.equals("Modifier12") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("MethodDeclarationBodyBlock")
				&& expectedType.equals("MethodDeclarationBody"))
			return true;
		if (type.equals("RelationalOp4") && expectedType.equals("RelationalOp"))
			return true;
		if (type.equals("PrimarySuffix7")
				&& expectedType.equals("PrimarySuffix"))
			return true;
		if (type.equals("CastLOOK_AHEAD3")
				&& expectedType.equals("CastLOOK_AHEAD"))
			return true;
		if (type.equals("EmptyStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("AllocationExpressionType")
				&& expectedType.equals("AllocationExpression"))
			return true;
		if (type.equals("AssignmentOperator3")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("WhileStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("UnaryOp1") && expectedType.equals("UnaryOp"))
			return true;
		if (type.equals("InnerAnnotationTypeDecl")
				&& expectedType.equals("ClassOrInterfaceBodyDeclaration"))
			return true;
		if (type.equals("Modifier11") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("PrimarySuffix6")
				&& expectedType.equals("PrimarySuffix"))
			return true;
		if (type.equals("BooleanLiteral2")
				&& expectedType.equals("BooleanLiteral"))
			return true;
		if (type.equals("FinalOrAnnotation1")
				&& expectedType.equals("FinalOrAnnotation"))
			return true;
		if (type.equals("FinalOrAbstract1")
				&& expectedType.equals("FinalOrAbstract"))
			return true;
		if (type.equals("SingleCatching")
				&& expectedType.equals("CatchBlockInternal"))
			return true;
		if (type.equals("Annotation2") && expectedType.equals("Annotation"))
			return true;
		if (type.equals("Modifier10") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("AnnoationEmptyDecl")
				&& expectedType.equals("AnnotationTypeMemberDeclaration"))
			return true;
		if (type.equals("VariableInitializerArray")
				&& expectedType.equals("VariableInitializer"))
			return true;
		if (type.equals("ResultType1") && expectedType.equals("ResultType"))
			return true;
		if (type.equals("PrimarySuffix5")
				&& expectedType.equals("PrimarySuffix"))
			return true;
		if (type.equals("LabeledStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("MemberValueConditionalExp")
				&& expectedType.equals("MemberValue"))
			return true;
		if (type.equals("PrimarySuffix3")
				&& expectedType.equals("PrimarySuffix"))
			return true;
		if (type.equals("FinalOrAbstract2")
				&& expectedType.equals("FinalOrAbstract"))
			return true;
		if (type.equals("FinalOrAnnotation2")
				&& expectedType.equals("FinalOrAnnotation"))
			return true;
		if (type.equals("MethodDecl")
				&& expectedType.equals("ClassOrInterfaceBodyDeclaration"))
			return true;
		if (type.equals("AllocationExpressionInitArrayDimsAndInits")
				&& expectedType.equals("AllocationExpressionInit"))
			return true;
		if (type.equals("AssignmentOperator1")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("AnnotationInnerTypeDecl")
				&& expectedType.equals("AnnotationTypeMemberDeclaration"))
			return true;
		if (type.equals("Annotation1") && expectedType.equals("Annotation"))
			return true;
		if (type.equals("ResultType2") && expectedType.equals("ResultType"))
			return true;
		if (type.equals("PrimarySuffix4")
				&& expectedType.equals("PrimarySuffix"))
			return true;
		if (type.equals("PreIncrementStmtExp")
				&& expectedType.equals("StatementExpression"))
			return true;
		if (type.equals("ForTraditional")
				&& expectedType.equals("ForStatementInternal"))
			return true;
		if (type.equals("PrimitiveType1")
				&& expectedType.equals("PrimitiveType"))
			return true;
		if (type.equals("PrimarySuffix2")
				&& expectedType.equals("PrimarySuffix"))
			return true;
		if (type.equals("ShiftOp2") && expectedType.equals("ShiftOp"))
			return true;
		if (type.equals("MemberSelector1")
				&& expectedType.equals("MemberSelector"))
			return true;
		if (type.equals("Modifier6") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("AssignmentOperator12")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("InnerBlockStmt")
				&& expectedType.equals("BlockStatementInternal"))
			return true;
		if (type.equals("Literal6") && expectedType.equals("Literal"))
			return true;
		if (type.equals("MemberValueArrayInitl")
				&& expectedType.equals("MemberValue"))
			return true;
		if (type.equals("ForInit2") && expectedType.equals("ForInit"))
			return true;
		if (type.equals("AssignmentOperator7")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("UnaryExpressionNotPlusMinusUnaryOp")
				&& expectedType.equals("UnaryExpressionNotPlusMinus"))
			return true;
		if (type.equals("CastLOOK_AHEADOp1")
				&& expectedType.equals("CastLOOK_AHEADOp"))
			return true;
		if (type.equals("ShiftOp1") && expectedType.equals("ShiftOp"))
			return true;
		if (type.equals("BooleanLiteral1")
				&& expectedType.equals("BooleanLiteral"))
			return true;
		if (type.equals("PrimarySuffix1")
				&& expectedType.equals("PrimarySuffix"))
			return true;
		if (type.equals("Modifier7") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("AssignmentOperator11")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("AssignmentOperator8")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("Annotation3") && expectedType.equals("Annotation"))
			return true;
		if (type.equals("CastLOOK_AHEADOp2")
				&& expectedType.equals("CastLOOK_AHEADOp"))
			return true;
		if (type.equals("ForInit1") && expectedType.equals("ForInit"))
			return true;
		if (type.equals("EmptyTypeDecl")
				&& expectedType.equals("TypeDeclaration"))
			return true;
		if (type.equals("PrimitiveType2")
				&& expectedType.equals("PrimitiveType"))
			return true;
		if (type.equals("CastLOOK_AHEAD2")
				&& expectedType.equals("CastLOOK_AHEAD"))
			return true;
		if (type.equals("Type1") && expectedType.equals("Type"))
			return true;
		if (type.equals("AssignmentOperator4")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("PrimaryPrefix8")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("ReturnStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("Modifier8") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("ExplicitConstructorInvocationSuper")
				&& expectedType.equals("ExplicitConstructorInvocation"))
			return true;
		if (type.equals("AssignmentOperator10")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("AnnotationTypeDecl")
				&& expectedType.equals("TypeDeclaration"))
			return true;
		if (type.equals("CastLOOK_AHEADOp3")
				&& expectedType.equals("CastLOOK_AHEADOp"))
			return true;
		if (type.equals("ReferenceType2")
				&& expectedType.equals("ReferenceType"))
			return true;
		if (type.equals("PrimitiveType3")
				&& expectedType.equals("PrimitiveType"))
			return true;
		if (type.equals("MemberValueAnnotation")
				&& expectedType.equals("MemberValue"))
			return true;
		if (type.equals("CastLOOK_AHEAD1")
				&& expectedType.equals("CastLOOK_AHEAD"))
			return true;
		if (type.equals("Type2") && expectedType.equals("Type"))
			return true;
		if (type.equals("MemberSelector2")
				&& expectedType.equals("MemberSelector"))
			return true;
		if (type.equals("BreakStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("MethodDeclarationBodyNone")
				&& expectedType.equals("MethodDeclarationBody"))
			return true;
		if (type.equals("AssignmentOperator5")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("PrimaryPrefix9")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("Modifier9") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("UnaryExpressionAdditive")
				&& expectedType.equals("UnaryExpression"))
			return true;
		if (type.equals("AssignmentStmtExp")
				&& expectedType.equals("StatementExpression"))
			return true;
		if (type.equals("PrimaryPrefix10")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("AssignmentOperator6")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("UnaryExpNotPlusMinus")
				&& expectedType.equals("UnaryExpression"))
			return true;
		if (type.equals("CastLOOK_AHEADOp4")
				&& expectedType.equals("CastLOOK_AHEADOp"))
			return true;
		if (type.equals("AllocationExpressionInitArguments")
				&& expectedType.equals("AllocationExpressionInit"))
			return true;
		if (type.equals("AnnotationTypeMemberDeclaration1")
				&& expectedType.equals("AnnotationTypeMemberDeclaration"))
			return true;
		if (type.equals("PrimitiveType4")
				&& expectedType.equals("PrimitiveType"))
			return true;
		if (type.equals("VariableInitializerExpression")
				&& expectedType.equals("VariableInitializer"))
			return true;
		if (type.equals("Modifier2") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("NewOrIdentifier2")
				&& expectedType.equals("NewOrIdentifier"))
			return true;
		if (type.equals("PrimaryPrefix6")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("Increment")
				&& expectedType.equals("StatementExpressionAssignment"))
			return true;
		if (type.equals("ContinueStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("UnaryExpressionNotPlusMinusCastExpression")
				&& expectedType.equals("UnaryExpressionNotPlusMinus"))
			return true;
		if (type.equals("Literal2") && expectedType.equals("Literal"))
			return true;
		if (type.equals("WildcardBounds2")
				&& expectedType.equals("WildcardBounds"))
			return true;
		if (type.equals("TypeArguments2")
				&& expectedType.equals("TypeArguments"))
			return true;
		if (type.equals("PrimaryPrefix11")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("ConstructorDecl")
				&& expectedType.equals("ClassOrInterfaceBodyDeclaration"))
			return true;
		if (type.equals("UnaryExpressionNotPlusMinusPostfixExpression")
				&& expectedType.equals("UnaryExpressionNotPlusMinus"))
			return true;
		if (type.equals("CastLOOK_AHEADOp5")
				&& expectedType.equals("CastLOOK_AHEADOp"))
			return true;
		if (type.equals("PrimitiveType5")
				&& expectedType.equals("PrimitiveType"))
			return true;
		if (type.equals("BlockAssertStmt")
				&& expectedType.equals("BlockStatementInternal"))
			return true;
		if (type.equals("ForStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("EmptyDecl")
				&& expectedType.equals("ClassOrInterfaceBodyDeclaration"))
			return true;
		if (type.equals("Modifier3") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("CastLOOK_AHEADOp6")
				&& expectedType.equals("CastLOOK_AHEADOp"))
			return true;
		if (type.equals("PrimaryPrefix7")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("PrimaryPrefix12")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("BlockLocalVariableDecl")
				&& expectedType.equals("BlockStatementInternal"))
			return true;
		if (type.equals("FieldDecl")
				&& expectedType.equals("ClassOrInterfaceBodyDeclaration"))
			return true;
		if (type.equals("Literal3") && expectedType.equals("Literal"))
			return true;
		if (type.equals("WildcardBounds1")
				&& expectedType.equals("WildcardBounds"))
			return true;
		if (type.equals("TypeArguments1")
				&& expectedType.equals("TypeArguments"))
			return true;
		if (type.equals("Decrement")
				&& expectedType.equals("StatementExpressionAssignment"))
			return true;
		if (type.equals("ExplicitConstructorInvocationThisArguments")
				&& expectedType.equals("ExplicitConstructorInvocation"))
			return true;
		if (type.equals("BlockClassOrInterfaceDecl")
				&& expectedType.equals("BlockStatementInternal"))
			return true;
		if (type.equals("BlockStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("VariableDeclaratorId3")
				&& expectedType.equals("VariableDeclaratorId"))
			return true;
		if (type.equals("PrimitiveType6")
				&& expectedType.equals("PrimitiveType"))
			return true;
		if (type.equals("ReferenceType1")
				&& expectedType.equals("ReferenceType"))
			return true;
		if (type.equals("AdditiveOp1") && expectedType.equals("AdditiveOp"))
			return true;
		if (type.equals("CastLOOK_AHEADOp7")
				&& expectedType.equals("CastLOOK_AHEADOp"))
			return true;
		if (type.equals("EqualityOp2") && expectedType.equals("EqualityOp"))
			return true;
		if (type.equals("ArrayDimsAndInits2")
				&& expectedType.equals("ArrayDimsAndInits"))
			return true;
		if (type.equals("ForEach")
				&& expectedType.equals("ForStatementInternal"))
			return true;
		if (type.equals("CastExpression1")
				&& expectedType.equals("CastExpression"))
			return true;
		if (type.equals("InitializerDecl")
				&& expectedType.equals("ClassOrInterfaceBodyDeclaration"))
			return true;
		if (type.equals("PrimaryPrefix13")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("ExpressionOrBlock1")
				&& expectedType.equals("ExpressionOrBlock"))
			return true;
		if (type.equals("Modifier4") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("UnaryPreIncrement")
				&& expectedType.equals("UnaryExpression"))
			return true;
		if (type.equals("LambdaExpression3")
				&& expectedType.equals("LambdaExpression"))
			return true;
		if (type.equals("AnnotationInnerClassDecl")
				&& expectedType.equals("AnnotationTypeMemberDeclaration"))
			return true;
		if (type.equals("AssignmentOperator9")
				&& expectedType.equals("AssignmentOperator"))
			return true;
		if (type.equals("Literal4") && expectedType.equals("Literal"))
			return true;
		if (type.equals("MultiplicativeOp3")
				&& expectedType.equals("MultiplicativeOp"))
			return true;
		if (type.equals("PrimaryPrefix3")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("VariableDeclaratorId2")
				&& expectedType.equals("VariableDeclaratorId"))
			return true;
		if (type.equals("PrimitiveType7")
				&& expectedType.equals("PrimitiveType"))
			return true;
		if (type.equals("IfStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("AdditiveOp2") && expectedType.equals("AdditiveOp"))
			return true;
		if (type.equals("ShiftOp3") && expectedType.equals("ShiftOp"))
			return true;
		if (type.equals("ArrayDimsAndInits1")
				&& expectedType.equals("ArrayDimsAndInits"))
			return true;
		if (type.equals("CastExpression2")
				&& expectedType.equals("CastExpression"))
			return true;
		if (type.equals("EqualityOp1") && expectedType.equals("EqualityOp"))
			return true;
		if (type.equals("CastLOOK_AHEADOp8")
				&& expectedType.equals("CastLOOK_AHEADOp"))
			return true;
		if (type.equals("NewOrIdentifier1")
				&& expectedType.equals("NewOrIdentifier"))
			return true;
		if (type.equals("PrimaryPrefix5")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("PrimaryPrefix14")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("Modifier5") && expectedType.equals("Modifier"))
			return true;
		if (type.equals("ExpressionOrBlock2")
				&& expectedType.equals("ExpressionOrBlock"))
			return true;
		if (type.equals("InnerClassDecl")
				&& expectedType.equals("ClassOrInterfaceBodyDeclaration"))
			return true;
		if (type.equals("ThrowStmt") && expectedType.equals("Statement"))
			return true;
		if (type.equals("DefaultSwitch") && expectedType.equals("SwitchLabel"))
			return true;
		if (type.equals("MultiplicativeOp2")
				&& expectedType.equals("MultiplicativeOp"))
			return true;
		if (type.equals("PrimaryPrefix4")
				&& expectedType.equals("PrimaryPrefix"))
			return true;
		if (type.equals("Literal5") && expectedType.equals("Literal"))
			return true;
		if (type.equals("VariableDeclaratorId1")
				&& expectedType.equals("VariableDeclaratorId"))
			return true;
		if (type.equals("PrimitiveType8")
				&& expectedType.equals("PrimitiveType"))
			return true;
		if (type.equals("StatementExp") && expectedType.equals("Statement"))
			return true;
		if (type.equals("CaseSwitchExp") && expectedType.equals("SwitchLabel"))
			return true;
		return false;
	}
}
