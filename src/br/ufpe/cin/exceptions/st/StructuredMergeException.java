...
public class StructuredMergeException extends Exception {
	...
	public StructuredMergeException(String incomingMessage, MergeContextSt context){
		super(detailErrorMessage(incomingMessage,context));
	}

	private static String detailErrorMessage(String incomingMessage,MergeContextSt context) {
