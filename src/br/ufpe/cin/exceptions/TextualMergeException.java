...
public class TextualMergeException extends Exception {
	...
	private static String detailErrorMessage(String incomingMessage, String leftContent,String baseContent, String rightContent) {
		...
		messageBuilder.append("\nLEFT CONTENT:\n" + ((!leftContent.isEmpty() && leftContent !=null)?leftContent:"<empty left>"));
		messageBuilder.append("\nBASE CONTENT:\n" + ((!baseContent.isEmpty() && baseContent !=null)?baseContent:"<empty base>"));
		messageBuilder.append("\nRIGHT CONTENT:\n"+ ((!rightContent.isEmpty()&& rightContent!=null)?rightContent:"<empty right>"));
