...
public class MergeContext {
	...
	public List<Triple<Side, FSTNode, FSTNode>> renamedWithoutBodyChanges = new ArrayList<>();
	public List<Triple<Side, FSTNode, FSTNode>> deletedOrRenamedWithBodyChanges = new ArrayList<>();
